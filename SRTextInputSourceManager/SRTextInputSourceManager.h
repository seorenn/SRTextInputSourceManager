...
//! Project version number for SRTextInputSourceManager.
FOUNDATION_EXPORT double SRTextInputSourceManagerVersionNumber;

//! Project version string for SRTextInputSourceManager.
