...
#if TARGET_OS_IPHONE
#warning SRTextInputSource was disabled because target platform is iOS
#else

#import <Cocoa/Cocoa.h>

@interface SRTextInputSourceImpl() {
...
@implementation SRTextInputSourceImpl
...
- (NSString *)description {
    return [NSString stringWithFormat:@"<SRTextInputSourceImpl: %@(%@)>", self.localizedName, self.ID];
}
